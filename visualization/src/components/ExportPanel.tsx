      ...
      >
        ...
        <div className="bg-gray-50 p-3 rounded-md border border-gray-100">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-xs text-gray-600">
            <li>
              <span className="font-medium text-blue-600">JSON:</span> Original
              data format. Ideal for reuse or import in other applications.
            </li>
            <li>
              <span className="font-medium text-purple-600">Markdown:</span>{' '}
              Readable document format. Can be displayed in GitHub and similar
              platforms.
            </li>
            <li>
              <span className="font-medium text-green-600">CSV:</span> Format
