...
export type WorkplanTopbarProps = {
  title: string;
  onBack: () => void;
  actions?: ReactNode;
 ...
 */
export function WorkplanTopbar({ title, onBack, actions, backButtonTitle = 'Back to dashboard' }: WorkplanTopbarProps) {
  return (
    <header className="app-topbar">
      <div className="topbar-inner">
        ...
        <div className="topbar-brand">
          ...
          <div className="topbar-subtitle" title={title}>{title}</div>
        </div>
